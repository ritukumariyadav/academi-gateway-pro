...
import {
  ...
  Monitor, MessageSquare, Home, Bus, Users,
} from "lucide-react";
import {
...
const allNav = [...mainNav, ...academicNav, ...servicesNav, ...commNav];
        ...
        <Sidebar collapsible="icon">
          ...
          <SidebarContent>
            {[
              ...
              { label: "Services", items: servicesNav },
              { label: "Communication", items: commNav },
            ].map(group => (
