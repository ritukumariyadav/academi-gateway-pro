...
const conversations = [
  { id: 1, from: "Dr. Smith (Faculty)", subject: "Assignment feedback", preview: "Good work on assignment 3...", time: "2 hours ago", unread: true },
  { id: 2, from: "Admin Office", subject: "Fee reminder", preview: "This is to remind you...", time: "1 day ago", unread: false },
];
    ...
    <div className="grid lg:grid-cols-3 gap-6">
      ...
      <Card className="lg:col-span-2">
        ...
        <CardContent className="space-y-4">
          <Input placeholder="To (teacher or admin)" />
